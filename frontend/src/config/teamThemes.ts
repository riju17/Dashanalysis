...
export const teamThemes: Record<string, TeamTheme> = {
  ...
  "Bundelkhand Bulls": {
    ...
    secondary: "#8B4513",
    accent: "#FCA5A5",
    gradient: "linear-gradient(135deg, rgba(220,20,60,0.95), rgba(139,69,19,0.9))",
    glow: "rgba(220,20,60,0.40)",
    darkBackground: "rgba(8,15,40,0.92)",
    border: "rgba(139,69,19,0.55)",
    ringGradient: "conic-gradient(from 180deg, #DC143C, #8B4513, #FCA5A5, #DC143C)",
  },
